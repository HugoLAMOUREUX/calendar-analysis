            ...
            {options
              ...
              .map(option => {
                ...
                return (
                  ...
                  >
                    {isSelected ? <MdCheckBox className="text-indigo-600" /> : <MdCheckBoxOutlineBlank className="text-gray-500" />}
                    <span className={`flex-1 ${isSelected ? "font-semibold text-indigo-600" : "font-normal"}`}>{option.label}</span>
                  </li>
                )
              })}
          </ul>
