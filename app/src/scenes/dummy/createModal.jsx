      ...
      <div className="p-6">
        ...
        <div className="flex justify-end items-center gap-3 mt-6">
          ...
          <LoadingButton
            ...
            className="px-4 py-2 text-sm font-medium text-white bg-indigo-600 rounded-md hover:bg-indigo-700 shadow-lg shadow-indigo-500/30 disabled:opacity-60 disabled:cursor-not-allowed"
          >
            Create
          </LoadingButton>
        </div>
