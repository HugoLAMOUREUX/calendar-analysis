    ...
    <div className="p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex border-b border-gray-200 mb-8">
          <Tab title="General Information" active={activeTab === "general"} onClick={() => setActiveTab("general")} Icon={HiOutlineInformationCircle} />
          <Tab title="Raw Data" active={activeTab === "raw"} onClick={() => setActiveTab("raw")} Icon={HiOutlineCodeBracket} />
        </div>

        {activeTab === "general" && <GeneralInfo event={event} />}
        {activeTab === "raw" && <RawData event={event} />}
      </div>
    </div>
  )
}
