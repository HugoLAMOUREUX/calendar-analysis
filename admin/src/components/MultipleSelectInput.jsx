      ...
      <div className="relative w-full">
        <TagsInput
          ...
          inputProps={{
            ...
            className: "w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all",
          }}
          ...
          renderTag={({ tag, key }) => (
            <span key={key} className="px-3 py-1 bg-indigo-100 text-indigo-700 text-xs font-semibold rounded-full flex items-center gap-1 transition-all border border-indigo-200">
              {tag}
              <button type="button" onClick={() => onChange(value.filter((e) => e !== tag))} className="hover:text-indigo-900 focus:outline-none transition-colors">
