...
import { FaStackExchange, FaUser, FaShieldHalved } from "react-icons/fa6";
...
const MENU = [
  { title: "Dashboard", to: "/", logo: <FaStackExchange className="h-6 w-6" /> },
  { title: "Users", to: "/user", logo: <FaUser className="h-6 w-6" /> },
  { title: "Admins", to: "/admin", logo: <FaShieldHalved className="h-6 w-6" /> },
];
              ...
              {!isNavCollapsed ? (
                <>
                  ...
                  <div>
                    ...
                    <p className="text-indigo-200 text-xs">Management</p>
                  </div>
                </>
              ) : (
