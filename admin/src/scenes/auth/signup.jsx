...
export default () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!ok) return toast.error(data?.message || "Error creating account");
      ...
      console.log("e", e);
      toast.error(e.code || "Error creating account");
    } finally {
      setBtnLoading(false);
    }
  };
  ...
  return (
    <div className="w-full max-w-md mx-auto p-4">
      <div className="bg-white rounded-2xl border border-indigo-100 shadow-xl p-6">
        <h1 className="text-2xl font-bold text-center text-gray-900 mb-2">Create Admin Account</h1>
        <p className="text-center text-gray-600 mb-6">Set up your administrator account</p>
