    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex gap-6 w-full justify-between">
          <SearchBar search={filter.search} setFilter={setFilter} placeholder="Search users..." />
            ...
            <div className="overflow-hidden border border-gray-200 shadow-sm rounded-lg bg-white">
              <table className="min-w-[600px] w-full divide-y divide-gray-200 rounded-lg overflow-hidden">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="p-3 text-left font-medium text-xs lg:text-sm text-gray-700 uppercase tracking-wider">Name</th>
                    <th className="p-3 text-left font-medium text-xs lg:text-sm text-gray-700 uppercase tracking-wider">Email</th>
                    <th className="p-3 text-left font-medium text-xs lg:text-sm text-gray-700 uppercase tracking-wider">Role</th>
                    <th className="p-3 text-left font-medium text-xs lg:text-sm text-gray-700 uppercase tracking-wider">Last Login</th>
                    <th className="p-3 text-left font-medium text-xs lg:text-sm text-gray-700 uppercase tracking-wider">Created At</th>
                  </tr>
                </thead>
                        ...
                        <td className="p-3 text-xs lg:text-sm">
                          <span
                            className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                              user.role === "client" ? "bg-green-100 text-green-800" : "bg-indigo-100 text-indigo-800"
                            }`}
                          >
                            {user.role || "user"}
                          </span>
